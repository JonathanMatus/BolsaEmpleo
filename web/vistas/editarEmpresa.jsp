                                ...
                                <form>
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" placeholder="" class="form-control" value="0" id="idEmpresa">
                                            <input type="hidden" placeholder="" class="form-control" value="0" id="idLocalizacion">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" form-group">
                                                ...
                                                <button type="button" id="editarEmpresa" class="btn btn-lg btn-info">Editar</button>
                                            </div>
...
<script src="../js/editarEmpresaJS.js" type="text/javascript"></script>
</body>
<script>
    $('#us2').locationpicker({
        location: {
